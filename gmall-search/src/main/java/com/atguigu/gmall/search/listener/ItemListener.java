...
public class ItemListener {
    ...
    public void listenerUpdate(SpuEntity spuEntity, Channel channel, Message message){
        ResponseVo skuResponseVo = this.pmsClient.update(spuEntity);
        SkuEntity skuEntity = (SkuEntity) skuResponseVo.getData();
